...
// Modify DialogContent to accept a custom className prop
const DialogContent = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Content>,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { customClass?: string }
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        customClass, // Add customClass to the className
        className
      )}
      {...props}
    >
